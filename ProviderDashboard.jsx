...
const emptyAct = { name: '', category: 'circuit', description: '', price: '', duration_hours: 2, max_participants: 10, destination_id: '', included: [], image: '' };
const emptyTrans = { type: 'flight', company: '', departure_city: '', arrival_city: '', departure_code: '', arrival_code: '', departure_time: '', arrival_time: '', price: '', available_seats: 100, total_seats: 180, class_type: 'economique', is_direct: true, stops: 0 };
            ...
            {currentItems.map((item, i) => (
              <motion.div key={item.id} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
                ...
                <div style={{ padding: 16 }}>
                  ...
                  {(item.ville_depart || item.departure_city) && <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: 8 }}>✈️ {item.compagnie || item.company}</p>}
                ...
                {modal.type === 'activities' && (<>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                    ...
                    <div className="input-group">
                      ...
                      <select value={form.category || 'circuit'} onChange={e => set('category', e.target.value)} className="input-field">
                ...
                {modal.type === 'transports' && (<>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                    ...
                    <div className="input-group">
                      ...
                      <select value={form.class_type || 'economique'} onChange={e => set('class_type', e.target.value)} className="input-field">
